...
def setup(ltp_api_key, ltp_api_secret, base_url=None, skip_ws=False, perp_dexs=None):
    ...
    info = Info(ltp_api_key, ltp_api_secret, base_url, skip_ws, perp_dexs=perp_dexs)
