...
def main():
    ...
    address, info, exchange = example_utils.setup(ltp_api_key, ltp_api_secret, constants.MAINNET_LTP_API_URL, skip_ws=True)
    ...
    response = info.query_sub_accounts(address)
    print(response)
